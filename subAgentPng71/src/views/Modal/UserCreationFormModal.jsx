...
const UserCreationFormModal = ({
  ...
  console.log('ParentUser', ParentUser,userType);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!formData.email || !formData.password || !formData.firstName || !formData.lastName || !formData.mobile || !formData.userId) {
        setMessage({
          type: 'danger',
      ...
      const submissionData = {
        ...
        referredBy: ParentUser?.referralCode || formData.referredBy || undefined,

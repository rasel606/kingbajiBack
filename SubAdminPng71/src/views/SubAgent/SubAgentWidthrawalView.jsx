...
const WidthrawalView = () => {
  ...
  const fetchDeposits = async () => {
    ...
    setError("");
    try {
      const res = await SubAdminServices.GetSubAgentPendingWidthrawalListList(filters);
  ...
  const handleStatusUpdate = async (transactionID, userId, actionType) => {
    setDepositLoading(true);
    try {
      const res = await SubAdminServices.updateDepositwidthrowalStatus(transactionID, userId, actionType);

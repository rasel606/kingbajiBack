...
import { SubAgentServices } from '../../service/SubAgentServices'
...
const SubAgentUserManagement = () => {
   ...
   const fetchUsers = async () => {
     setLoading(true)
     try {
       const response = await SubAgentServices.GetAgentList(filters)
   ...
   //   };
     ...
     getUserById: SubAgentServices.getAgentUserById,
     updateUserProfileById: SubAgentServices.updateUserProfileById,
     verifyEmailForUser: SubAgentServices.verifyEmailForUser,
     verifyPhoneForUser: SubAgentServices.verifyPhoneForUser,

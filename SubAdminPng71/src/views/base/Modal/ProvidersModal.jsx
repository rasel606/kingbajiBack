    ...
    try {
      ...
      const submitData = {
        ...
        g_type: Array.isArray(formData.g_type) 
          ? formData.g_type 
          : formData.g_type.split(',').map(item => item.trim()).filter(item => item)
      };
          ...
          {loading ? (
            ...
            <CRow className="g-3">
              ...
              <CCol xs={12} md={6}>
                ...
                <CFormInput
                  value={Array.isArray(formData.g_type) ? formData.g_type.join(', ') : formData.g_type}
                  onChange={(e) => handleGameTypesChange(e.target.value)}
                  placeholder="slot, live, poker, etc."
                />
                <small className="text-muted">
                  Enter game types separated by commas
                </small>
              </CCol>

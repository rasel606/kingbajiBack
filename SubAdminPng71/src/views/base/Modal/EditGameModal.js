...
const EditGameModal = ({ 
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!formData.gameName_enus || !formData.category_name || !formData.provider || !formData.g_code) {
    ...
    <CModal visible={show} onClose={handleClose} size="lg" backdrop="static">
      <CModalHeader>
        <CModalTitle>
          Edit Game
          <div className="mt-1">
            <CBadge color="secondary" className="me-2">ID: {game._id}</CBadge>
                  ...
                  <div className="d-flex align-items-center">
                    ...
                    <CFormLabel htmlFor="edit-active-switch" className="mb-0 ms-2">
                      Active {formData.is_active ? 
                        <CBadge color="success" className="ms-1">Live</CBadge> : 
                        <CBadge color="secondary" className="ms-1">Disabled</CBadge>
                      }
                    </CFormLabel>
                  </div>
                </CCol>
                ...
                <CCol md={4}>
                  <div className="d-flex align-items-center">
                    ...
                    <CFormLabel htmlFor="edit-hot-switch" className="mb-0 ms-2">
                      Hot Game {formData.is_hot && 
                        <CBadge color="danger" className="ms-1">HOT</CBadge>
                      }
                    </CFormLabel>
                  </div>
                </CCol>
                  ...
                  <div className="d-flex align-items-center">
                    ...
                    <CFormLabel htmlFor="edit-featured-switch" className="mb-0 ms-2">
                      Featured {formData.isFeatured && 
                        <CBadge color="warning" className="ms-1">FEATURED</CBadge>
                      }
                    </CFormLabel>
                  </div>
                </CCol>

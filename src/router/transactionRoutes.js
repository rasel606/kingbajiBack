...
router.get('/deposits/search', validate, auth, AdminController.getPendingDepositTransactions);
router.get('/withdrawals/search', validate, auth, AdminController.getPendingWidthrawalTransactions);

...
//         const requestUrl = `http://gsmd.336699bet.com/launchGames.aspx?operatorcode=${OPERATOR_CODE}&providercode=${PROVIDER_CODE}&username=${username}&password=${password}&type=${type}&gameid=${"0"}&lang=${"en-US"}&html5=${html5}&signature=${signature}`;

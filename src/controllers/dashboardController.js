...
const { getPeriodDates, getTurnoverStats } = require('../utils/periodUtils');
    ...
    const [
      ...
      (async () => {
        const [
          ...
          getTurnoverStats(BettingHistory, referredUserIds, todayStart, todayEnd),
          getTurnoverStats(BettingHistory, referredUserIds, yesterdayStart, yesterdayEnd),
          getTurnoverStats(BettingHistory, referredUserIds, startOfWeek),
          getTurnoverStats(BettingHistory, referredUserIds, startOfLastWeek, startOfWeek),
          getTurnoverStats(BettingHistory, referredUserIds, currentPeriodStart, currentPeriodEnd),
          getTurnoverStats(BettingHistory, referredUserIds, lastPeriodStart, lastPeriodEnd)
        ]);

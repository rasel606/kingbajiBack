...
const EditGameModal = ({ show, onHide, game = null, categories = [], providers = [], onUpdateSuccess }) => {
  ...
  return (
    <CModal visible={show} onClose={handleClose} size="lg">
      <CModalHeader>
        <CModalTitle>Edit Game</CModalTitle>
      </CModalHeader>
      ...
      <CForm onSubmit={handleSubmit}>
        ...
        <CModalFooter>
          ...
          <CButton color="primary" type="submit" disabled={saving || !game?._id}>
            {saving ? <CSpinner size="sm" /> : "Update"}
          </CButton>
        </CModalFooter>
      </CForm>
    </CModal>

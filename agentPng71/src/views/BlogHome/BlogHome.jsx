...
const BlogHome = () => {
  ...
  const blogPosts = [
    ...
    },
    {
      ...
      excerpt: "Explore the latest JavaScript features including arrow functions, destructuring, and async/await.",
    ...
    },
    {
      ...
      excerpt: "Master the art of responsive web design and create websites that work perfectly on all devices.",
          ...
          <CRow className="align-items-center">
            <CCol lg={8}>
              ...
              <p className="lead mb-4">
                Discover amazing articles about web development, programming tips, 

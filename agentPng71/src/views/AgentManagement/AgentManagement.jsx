...
import { agentListTableConfig } from "../base/tableConfig/agentListTableConfig";
...
const AgentManagement = () => {
  ...
  const fetchSubAdmins = async () => {
    setLoading(true);
    try {
      const response = await adminServices.AdminAgentList(filters);

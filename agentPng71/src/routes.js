...
const AffiliateCommissionSettings =React.lazy(() => import('./views/AffiliateManagement/AffiliateCommissionSettings'))
...
const SubAdminAffiliateManagement =React.lazy(() => import( './views/subAdmin/SubAdminAffiliateManagement'))
const AffiliateManagement =React.lazy(() => import( './views/AffiliateManagement/AffiliateManagement'))
...
const AnalyticsDashboard = React.lazy(() => import('./views/dashboard/AnalyticsDashboard'))
...
const routes = [
  ...
  { path: '/Subagent/agentUserList', name: 'AgentList', element: SubAgentUserManagement },
  ...
  { path: '/admin/affiliate/affiliateCommission', name: 'Accordion', element: AffiliateCommissionSettings },
